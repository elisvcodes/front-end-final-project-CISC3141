...
const Tables = () => {
  ...
  const createBug = (data) => {
    axios
      .post(
        'http://bugtracker-env.eba-cnmv7y5g.us-east-2.elasticbeanstalk.com/create-bug',
        data,
        { headers }
      )
  ...
  const deleteBugs = (id) => {
    axios
      .delete(
        'http://bugtracker-env.eba-cnmv7y5g.us-east-2.elasticbeanstalk.com/delete-bug',
        { data: { id: id }, headers }
        // { headers }
      )
      .then((res) => console.log(res.data))
  ...
  const fetchUrl =
    'http://bugtracker-env.eba-cnmv7y5g.us-east-2.elasticbeanstalk.com/get-bugs';
  useEffect(() => {
    axios.get(fetchUrl, { headers }).then((res) => setPosts(res.data));
  ...
  return (
    <div>
      <div className='d-flex flex-row'>
        <button
          type='button'
          className='me-3 btn btn-secondary ml-auto d-block mb-2 '
